...
class Attack(object):
    ...
    def forward(self, images, texts, labels=None, *args, **kwargs):
        r"""
    ...
    def get_logits(self, images, texts, labels=None, *args, **kwargs):
    ...
    def __call__(self, inputs, texts, labels=None, *args, **kwargs):
        given_training = self.model.training
        ...
        if self._normalization_applied is True:
            ...
            adv_inputs = self.forward(inputs, texts, labels, *args, **kwargs)
